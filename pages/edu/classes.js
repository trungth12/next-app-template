...
import Ages from '../../components/edu/sche_classes'
import {query as agesQuery} from '../../components/edu/sche_classes/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/classes/locales/${language}/messages`)
  }
  return {
    catalogs,
