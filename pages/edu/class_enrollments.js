...
import Ages from '../../components/edu/sche_class_enrollments'
import {query as agesQuery} from '../../components/edu/sche_class_enrollments/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/class_enrollments/locales/${language}/messages`)
  }
  return {
    catalogs,
    redux: 'REDUX_STORE_EDU_CLASS_ENROLLMENTS',
    apollo: {
