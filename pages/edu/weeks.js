...
import Ages from '../../components/edu/sche_weeks'
import {query as agesQuery} from '../../components/edu/sche_weeks/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/weeks/locales/${language}/messages`)
  }
  return {
    catalogs,
