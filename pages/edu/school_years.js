...
import Ages from '../../components/edu/sche_school_years'
import {query as agesQuery} from '../../components/edu/sche_school_years/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/school_years/locales/${language}/messages`)
  }
  return {
    catalogs,
    redux: 'REDUX_STORE_EDU_SCHOOL_YEAR',
    apollo: {
