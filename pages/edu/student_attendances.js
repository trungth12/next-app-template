...
import Ages from '../../components/edu/sche_class_attendances'
import {query as agesQuery} from '../../components/edu/sche_class_attendances/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/student_attendances/locales/${language}/messages`)
  }
  return {
    catalogs,
    redux: 'REDUX_STORE_EDU_STUDENT_ATTENDANCES',
    apollo: {
