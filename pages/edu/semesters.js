...
import Ages from '../../components/edu/sche_semesters'
import {query as agesQuery} from '../../components/edu/sche_semesters/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/semesters/locales/${language}/messages`)
  }
  return {
    catalogs,
