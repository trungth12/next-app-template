...
import Ages from '../../components/edu/sche_terms'
import {query as agesQuery} from '../../components/edu/sche_terms/index.gql'
/*
...
Page.getInitialConfig = async ({language}) => {  
  const catalogs = {
    [language]: await import(`../../locales/edu/terms/locales/${language}/messages`)
  }
  return {
    catalogs,
    redux: 'REDUX_STORE_EDU_TERM',
    apollo: {
